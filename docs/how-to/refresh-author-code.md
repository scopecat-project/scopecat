...
This runtime requires **project schema 68**, which stores preparation operations
...
matching pinned readers; start a separate schema 68 project. No implicit migration
is supplied.

Within schema 68, [backup and restore](backup-and-restore.md) retains source
