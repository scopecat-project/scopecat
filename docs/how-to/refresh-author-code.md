...
This runtime requires **project schema 67**, which stores preparation operations
...
matching pinned readers; start a separate schema 67 project. No implicit migration
is supplied.

Within schema 67, [backup and restore](backup-and-restore.md) retains source
