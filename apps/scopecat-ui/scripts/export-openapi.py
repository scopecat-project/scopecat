...
_OPERATIONS = {
    ...
    ("/api/v1/setup/activation-operations", "post"),
    ("/api/v1/config-registry/setup-rebindings", "post"),
    ("/api/v1/config-registry/setup-rebindings/preview", "post"),
    ...
    ("/api/v1/research-projects/{project_id}/members/{kind}/{identity}", "put"),
    ("/api/v1/research-projects/{project_id}/members/{kind}/{identity}", "delete"),
    ("/api/v1/author-revisions", "get"),
    ("/api/v1/author-preparations", "post"),
    ("/api/v1/author-preparations", "get"),
    ("/api/v1/author-preparations/{operation_id}", "get"),
    ("/api/v1/author-preparations/{operation_id}/cancel", "post"),
    ("/api/v1/run-comparison", "post"),
    ("/api/v1/procedures/{procedure_run_id}/cancel", "post"),
    ("/api/v1/experiment-launcher/submit", "post"),
    ("/api/v1/runs/{run_id}/request", "get"),
    ("/api/v1/experiment-plans", "get"),
    ("/api/v1/experiment-plans", "post"),
    ("/api/v1/experiment-plans/read", "post"),
    ("/api/v1/experiment-plans/hide", "post"),
